...
import { ModelSelect } from "~/components/client/image/ModelSelect";
import { PromptInput } from "~/components/client/image/PromptInput";
import { ModelCardCarousel } from "~/components/client/image/ModelCardCarousel";
import {
  MODEL_CONFIGS,
  PROVIDERS,
  PROVIDER_ORDER,
...
export function ImagePlayground({
  ...
  const providerToModel = {
    fireworks1: selectedModels.fireworks1,
    fireworks2: selectedModels.fireworks2,
    fireworks3: selectedModels.fireworks3,
  };


  const handlePromptSubmit = (newPrompt: string, aspectRatio: string) => {
          ...
          {(() => {
            ...
            return (
              <>
                ...
                <div className="hidden md:grid md:grid-cols-2 2xl:grid-cols-3 gap-8">
